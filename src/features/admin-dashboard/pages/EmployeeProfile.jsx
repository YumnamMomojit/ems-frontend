                    ...
                    <div className="bg-card border rounded-2xl p-6 space-y-6">
                        ...
                        <div className="flex flex-col items-center text-center">
                            <div className="relative mb-4">
                                ...
                                <div className={`absolute -bottom-1 -right-1 h-6 w-6 ${employee.status === 'ACTIVE' ? 'bg-green-500' : 'bg-red-500'} border-4 border-card rounded-full`} title={employee.status}></div>
                            </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            {employee.reportsTo && (
                                <div>
                                    ...
                                    <p className="text-sm font-medium mt-1">{employee.reportsTo.firstName} {employee.reportsTo.lastName}</p>
                                </div>
                            )}
                            ...
                            <div>
                                ...
                                <p className="text-sm font-medium mt-1">{employee.user?.role?.replace('_', ' ') || 'N/A'}</p>
                            </div>
                        </div>
                    </div>

                    {/* View Documents Button - Placeholder for now, link to admin docs if needed */}
                    {/* <div className="bg-card border rounded-2xl p-6">
                        <button
